...
class PtsV2PaymentsPost201ResponseProcessorInformation implements ArrayAccess
{
    ...
    {
        if (!is_null($responseCategoryCode) && (strlen($responseCategoryCode) > 40)) {
            throw new \InvalidArgumentException('invalid length for $responseCategoryCode when calling PtsV2PaymentsPost201ResponseProcessorInformation., must be smaller than or equal to 40.');
        }
